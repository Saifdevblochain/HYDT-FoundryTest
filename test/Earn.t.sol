...
contract EarnTest is EarnEvents,Test {
    ...
    //     // assertEq(balanceAfterUnstakehygt, uint(89999999999995550032) );
    //     // earn.poolInfo(0);
    //     // earn.poolShares(0,0);
 ...
 function test_stake_MultipleStakes_SametimeAndStakeType ( ) public {
    ...
    console.log("wallet5::::::",getpayouttype5);
    ...
    //     earn.claimPayout(0);
    //     vm.stopPrank();
    //     console.log("balance of wallet1 -----",hygt.balanceOf(address(wallet1)));
    //     console.log("balance of wallet2 -----",hygt.balanceOf(address(wallet2)));
    //     console.log("balance of wallet3 -----",hydt.balanceOf(address(wallet3)));
    //     console.log("balance of wallet4 -----",hydt.balanceOf(address(wallet4)));
    //     console.log("balance of wallet5 -----",hygt.balanceOf(address(wallet5)));
    ...
    // //     uint256 rewardDebt)=earn.getStakings(address(this), 0);
    //     // console.log("endTime is -----",endTime);

    //     // console.log("balance of this -----",hydt.balanceOf(address(this)));
        
    //     // uint256 amountMint = earn.getPayout(address(this), 0);
    //     // earn.updatePool(0);
    //     // uint256 pending = earn.getPending(address(this), 0);
    ...
    function test_stake_MultipleStakes_DifferentTime_TESTTT( ) public {
        initializing();
        address wallet1= address(123);
        hydt.transfer(wallet1, 10e18);
        ...
        (, , ,,,uint256 endTime,,)= earn.getStakings(address(wallet1),0);
        console.log("endTime--------",endTime);

        vm.warp(70000);
        // earn.claimPayout(0);
        // earn.updatePool(0);
        uint x = earn.getPending(wallet1, 0);
        console.log("x is : ",x);
        vm.stopPrank();
